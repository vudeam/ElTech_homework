...
template <class _Item>
class Matrix3x3 : public Matrix<_Item> {
public:
	Matrix3x3(void);
	Matrix3x3(_Item**);
	_Item Det(void);
...
/*
template Matrix<double>::Matrix(void);
template Matrix<double>::Matrix(double**, size_t, size_t);
template double Matrix<double>::Det(void);
template void  Matrix<double>::Print(void);

template Matrix3x3<double>::Matrix3x3(void);
template Matrix3x3<double>::Matrix3x3(double**);
template double Matrix3x3<double>::Det(void);
template double Matrix3x3<double>::Det1(double*);
template double Matrix3x3<double>::Det2(double*);
template double Matrix3x3<double>::Det3(double*);
*/
